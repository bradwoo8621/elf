...
use std::sync::Arc;
use watchmen_model::{
    FactorType, StdErrorCode, StdR, TopicDataProperty, TopicDataUtils, TopicDataValue,
};
...
impl InMemoryParameter for CompiledTopicFactorParameter {
    fn value_from<'a>(&self, variables: &'a PipelineExecutionVariables) -> StdR<&'a TopicDataValue> {
