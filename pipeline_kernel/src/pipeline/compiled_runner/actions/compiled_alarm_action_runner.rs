use crate::{
    ActionRunResult, CompiledAlarmAction, CompiledPipeline, CompiledStage, CompiledUnit,
...
impl SpecCompiledActionRunner for CompiledAlarmActionRunner {
    type SourceCompiledAction = CompiledAlarmAction;
