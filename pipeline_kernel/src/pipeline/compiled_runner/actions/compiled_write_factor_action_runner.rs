use crate::{
    ActionRunResult, CompiledPipeline, CompiledStage, CompiledUnit, CompiledWriteFactorAction,
...
impl SpecCompiledActionRunner for CompiledWriteFactorActionRunner {
    type SourceCompiledAction = CompiledWriteFactorAction;
