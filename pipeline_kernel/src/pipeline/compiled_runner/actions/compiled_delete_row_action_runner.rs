use crate::{
    ActionRunResult, CompiledDeleteRowAction, CompiledPipeline, CompiledStage, CompiledUnit,
...
impl SpecCompiledActionRunner for CompiledDeleteRowActionRunner {
    type SourceCompiledAction = CompiledDeleteRowAction;
