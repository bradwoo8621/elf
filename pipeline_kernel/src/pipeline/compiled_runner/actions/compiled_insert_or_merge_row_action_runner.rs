use crate::{
    create_spec_action_runner, ActionRunResult, CompiledInsertOrMergeRowAction, CompiledPipeline, CompiledStage,
...
create_spec_action_runner!(CompiledInsertOrMergeRowAction);
