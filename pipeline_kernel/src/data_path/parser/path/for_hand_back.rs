...
impl DataPathParser {
    ...
    fn hand_back_to(self, end_char_index_offset: usize, func: &mut impl DataPathAnyFuncParser) {
    ...
    pub fn hand_back_to_func(self, func: &mut impl DataPathAnyFuncParser) {
        self.hand_back_to(0, func)
    }

    /// hand back to literal concat parser.
    /// when back, the char index is after the closing "}".
    pub fn hand_back_to_literal_concat(self, func: &mut impl DataPathAnyFuncParser) {
